...
Codebase: 255 tests passing. All security hardening (S-2…S-21, N-1…N-3) reflected.
...
║     │       │          │          │          │          │          │         ║
║  ┌──┴───┐┌──┴────┐ ┌───┴───┐ ┌───┴────┐ ┌───┴───┐ ┌───┴────┐ ┌──┴──────┐  ║
║  │GEOM  ││PROBE  │ │ENCLAVE│ │ATTEST  │ │STORE  │ │REGISTRY│ │EXCHANGE │  ║
║  │      ││       │ │       │ │        │ │       │ │        │ │         │  ║
║  │got   ││got    │ │got    │ │got     │ │got    │ │got-wire│ │got-wire │  ║
║  │-core ││-probe │ │-encl  │ │-attest │ │-store │ │::reg   │ │::exch   │  ║
║  │      ││       │ │       │ │        │ │       │ │        │ │         │  ║
║  │Causal││Measrmt│ │Mock   │ │assemble│ │Memory │ │Trust   │ │build_   │  ║
║  │Geom  ││Hook   │ │Enclave│ │_and_   │ │Store  │ │Registry│ │request()│  ║
║  │Φ=UᵀU ││Collctr│ │enclave│ │sign()  │ │File   │ │lookup()│ │build_   │  ║
║  │drift ││Sidecar│ │_pipe  │ │verify()│ │Store  │ │S-2:SHA │ │response │  ║
║  │      ││Stats  │ │_line()│ │S-7/13  │ │append │ │integr  │ │validate │  ║
║  │S-21: ││N-2:   │ │       │ │S-20    │ │query  │ │age_sec │ │_request │  ║
║  │model ││poison │ │       │ │merkle  │ │audit  │ │mdl_hsh │ │_response│  ║
║  │hash  ││recov  │ │       │ │_root() │ │chain  │ │        │ │perform_ │  ║
║  │Optn  ││       │ │       │ │        │ │       │ │        │ │exchange │  ║
║  └──┬───┘└──┬────┘ └───┬───┘ └───┬────┘ └───┬───┘ └───┬────┘ └──┬──────┘  ║
║     │       │          │          │          │          │          │         ║
║  ───┴───────┴──────────┴──────────┴──────────┴──────────┴──────────┴───      ║
